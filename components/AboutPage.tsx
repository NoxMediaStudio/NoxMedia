...
const GITHUB_API_URL = 'https://api.github.com/repos/PhilippeBoechat/NoxMedia';
...
const AboutPage = () => {
    ...
    useEffect(() => {
        ...
        fetchStars();
        const interval = setInterval(fetchStars, 100); // Atualiza a cada 5s
        return () => {
            isMounted = false;
    ...
    const stats = [
        ...
        { icon: Star, value: stars !== null ? stars.toString() : "-", label: "Stars no GitHub" },
                            ...
                            <div className="flex items-center space-x-4 bg-slate-800/40 border border-slate-700/50 rounded-xl p-6">
                                ...
                                <div className="flex-grow">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h4 className="text-lg font-semibold text-white">Sistema de ChatBot</h4>
                                            <p className="text-slate-400">70% completo. Adição do Painel Admin.</p>
                                        </div>
                ...
                <section className="text-center">
                    <div className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-12">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="/donate" className="inline-flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200">
                                <Coffee className="w-5 h-5" />
                                <span>Apoiar com Doação</span>
                            </a>
                            <a href="https://github.com/PhilippeBoechat/NoxMedia" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 bg-slate-700 hover:bg-slate-600 text-white font-semibold py-3 px-6 rounded-lg border border-slate-600 transition-colors duration-200">
